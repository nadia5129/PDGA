            ...
            <tbody>
                ...
                <section class="graphs">
                    <div class="graphcontainer">
                        <figure>
                            <h3>Total Prize Purse by Year (<?php echo h($series['name']); ?>)</h3>
                            <!-- ECharts container -->
                            <div id="cashChart"></div>
                            <figcaption>Total prize purse for <?php echo h($series['name']); ?> by year</figcaption>
                        </figure>
                        <figure>
                            <h3>Average Total Score by Year (<?php echo h($series['name']); ?>)</h3>
                            <!-- ECharts container -->
                            <div id="ratingChart"></div>
                            <figcaption>Average total score for <?php echo h($series['name']); ?> by year</figcaption>
                        </figure>
                         <!--new changes added -->
                        <figure>
                            <h3>Field Size (Players) by Year (<?php echo h($series['name']); ?>)</h3>
                     ...
                     <style>
                        ...
                        .graphcontainer #playersChart { width:100%; height:320px; }
                     </style>
                </section>
